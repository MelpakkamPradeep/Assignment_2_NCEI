...
reqloc = "{{ dag_run.conf.reqloc }}"  # Location of the data files
required_fields = "{{ dag_run.conf.required_fields }}"  # List of required fields to process

# Define the DAG configuration
dag = DAG(
    'process_ncei_data_conf',  # Name of the DAG
    ...
    schedule_interval='@daily',  # Schedule interval of the DAG
    catchup=False  # Catch up option for the DAG
)
